...
String extractTotalDetalle = Mobile.getText(findTestObject('Object Repository/Finalizar Pickup/android.widget.TextView - Total detalle orden sin cupon pickup 2'), 
    0).replaceAll('[^0-9]', '')
