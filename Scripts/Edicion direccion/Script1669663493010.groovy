...
Mobile.tap(findTestObject('Edicion direccion/android.widget.ImageView tres puntitos'), 0)
...
'edicion logo'
Mobile.tap(findTestObject('Edicion direccion/android.widget.ImageView logo edicion'), 0)
