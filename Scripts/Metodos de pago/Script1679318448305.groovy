...
Mobile.getText(findTestObject('Object Repository/Metodos de pago/android.widget.TextView - Mtodos de pagos'), 0)
...
Mobile.getText(findTestObject('Object Repository/Metodos de pago/android.widget.TextView - S, es mi preferida'), 0)

Mobile.tap(findTestObject('Object Repository/Metodos de pago/android.widget.TextView - S, es mi preferida'), 0)
