...
Mobile.getText(findTestObject('Object Repository/Cuponera/android.widget.TextView - Cupones de Descuento (1)'), 0)

Mobile.getText(findTestObject('Object Repository/Cuponera/android.widget.TextView - Disfrut con Monchis'), 0)
